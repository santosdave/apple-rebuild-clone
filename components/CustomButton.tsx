...
export default function CustomButton({ title, onClick, width, loading, padding, noIcon }: Props) {
    return (
        <button
            ...
            ${width ? width : 'w-auto'} ${padding} cursor-pointer items-center justify-center overflow-hidden rounded bg-indigo-600  bg-gradient-to-r from-pink-500 to-violet-500 px-8 py-3 font-bold text-white transition-all duration-300 focus:outline-none
            `}
        >
